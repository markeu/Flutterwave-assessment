const filePath = require("../db/data.json");
...
const createData = (req, res) => {
    ...
    if (!rule || typeof rule === 'number') {
        output.message = rule ? `rule should be an object.` : `rule is require`;
        output.status = "error";
        output.data = null;
    ...
    condition = presentCondition === 'gt' ? value > rule.condition_value :
